      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="inline-block mb-4">
              <span className="font-display text-3xl font-bold text-gradient">W1CK</span>
            </a>
            <p className="text-muted-foreground max-w-sm mb-6">
              Empowering traders worldwide with proven strategies and a supportive community to achieve financial freedom.
            </p>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} W1CK Trading. All rights reserved.
          </p>
